...
-- ============================================================
-- Групповые чаты («Группы»)
-- ============================================================

-- Группа (аналог "сервера"); имя `groups` зарезервировано в MySQL, поэтому chat_groups
...
-- Участники группы (макс. 10, проверяется в коде)
...
-- Сообщения в каналах групп (type='system' — сервисные, sender_id=NULL)
...
-- Приглашения в группу (доставляются плашкой в ЛС)
