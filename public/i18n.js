(function() {
    const translations = {
        en: {
            ...
            "voice_type_text": "# Text",
            "voice_type_voice": "🔊 Voice",
            ...
            "voice_channel": "Voice",
            "voice_reconnect_failed": "Connection lost",
            "call_start": "Call",
            ...
            "group_change_avatar": "Change group avatar",
            "group_remove_avatar": "Remove avatar",
            ...
            "group_kick": "Remove",
            "group_mute": "Mute notifications",
            "group_unmute": "Unmute notifications",
            "group_invite_modal_title": "Invite a friend",
            "group_action_invite": "Invite a friend",
            "group_pin": "Pin",
            "group_unpin": "Unpin",
            "group_kick_confirm": "Remove this member?",
            "group_channel_delete_confirm": "Delete this channel?",
            "group_muted": "Notifications muted",
            "group_channel_rename": "Rename channel",
            "group_channel_delete": "Delete channel",
            "group_channel_rename_prompt": "New channel name:",
            "group_chat_banned": "Chat access denied",
            "group_mic_off": "Microphone disabled",
            "group_ban_chat": "Restrict chat",
            "group_allow_chat": "Allow chat",
            "group_disable_mic": "Disable microphone",
            "group_enable_mic": "Enable microphone",
            "group_chat_ban_notice": "The admin has restricted your access to this group's chat.",
            ...
            "profile_delete_confirm_sure": "Are you sure you want to delete your account? This is irreversible — all data will be wiped forever.",
            ...
            "login_btn": "Sign In",
            "login_forgot_hint": "Forgot your password?",
            "login_reset_link": "Reset password",
            "login_reset_need_user": "Enter your login or email to reset the password",
            "reset_title": "Reset password",
            "reset_hint": "A confirmation code was sent to your email. Enter it to verify your identity.",
            "reset_code_placeholder": "Code from email",
            "reset_verify_btn": "Confirm code",
            "reset_new_password_placeholder": "New password",
            "reset_confirm_btn": "Change password",
            "reset_back_login": "← Back to login",
            "reset_no_user": "Start the reset from the login page.",
            "reset_enter_code": "Enter the code from the email",
            "reset_code_ok": "Code confirmed. Enter a new password.",
            "reset_code_bad": "Invalid or expired code",
            "reset_enter_password": "Enter a new password",
            "reset_success": "Password changed! Redirecting to login…",
            "reset_fail": "Could not change the password",
        ...
        ru: {
            ...
            "voice_channel": "Голос",
            "voice_reconnect_failed": "Соединение потеряно",
            ...
            "group_change_avatar": "Сменить аватар группы",
            "group_remove_avatar": "Убрать аватар",
            ...
            "group_kick": "Удалить",
            "group_mute": "Отключить уведомления",
            "group_unmute": "Включить уведомления",
            "group_invite_modal_title": "Пригласить друга",
            "group_action_invite": "Пригласить друга",
            "group_pin": "Закрепить",
            "group_unpin": "Открепить",
            "group_kick_confirm": "Удалить этого участника?",
            "group_channel_delete_confirm": "Удалить этот канал?",
            "group_muted": "Уведомления отключены",
            "group_channel_rename": "Переименовать канал",
            "group_channel_delete": "Удалить канал",
            "group_channel_rename_prompt": "Новое название канала:",
            "group_chat_banned": "Доступ к чату запрещён",
            "group_mic_off": "Микрофон отключён",
            "group_ban_chat": "Запретить чат",
            "group_allow_chat": "Разрешить чат",
            "group_disable_mic": "Отключить микрофон",
            "group_enable_mic": "Включить микрофон",
            "group_chat_ban_notice": "Админ ограничил вам доступ к чату этой группы.",
            "modal_input_title": "ВВОД",
            ...
            "profile_delete_confirm_sure": "Вы точно хотите удалить аккаунт? Это действие необратимо — все данные будут стёрты навсегда.",
            ...
            "login_btn": "Войти",
            "login_forgot_hint": "Забыли пароль?",
            "login_reset_link": "Сбросить пароль",
            "login_reset_need_user": "Введите логин или email, чтобы сбросить пароль",
            "reset_title": "Сброс пароля",
            "reset_hint": "На вашу почту отправлен код подтверждения. Введите его, чтобы подтвердить личность.",
            "reset_code_placeholder": "Код из письма",
            "reset_verify_btn": "Подтвердить код",
            "reset_new_password_placeholder": "Новый пароль",
            "reset_confirm_btn": "Сменить пароль",
            "reset_back_login": "← Назад ко входу",
            "reset_no_user": "Начните сброс со страницы входа.",
            "reset_enter_code": "Введите код из письма",
            "reset_code_ok": "Код подтверждён. Введите новый пароль.",
            "reset_code_bad": "Неверный или устаревший код",
            "reset_enter_password": "Введите новый пароль",
            "reset_success": "Пароль изменён! Сейчас перейдём ко входу…",
            "reset_fail": "Не удалось сменить пароль",
        ...
        uk: {
            ...
            "group_change_avatar": "Змінити аватар групи",
            "group_remove_avatar": "Прибрати аватар",
            ...
            "group_kick": "Видалити",
            "group_mute": "Вимкнути сповіщення",
            "group_unmute": "Увімкнути сповіщення",
            "group_invite_modal_title": "Запросити друга",
            "group_action_invite": "Запросити друга",
            "group_pin": "Закріпити",
            "group_unpin": "Відкріпити",
            "group_kick_confirm": "Видалити цього учасника?",
            "group_channel_delete_confirm": "Видалити цей канал?",
            "group_muted": "Сповіщення вимкнено",
            "group_channel_rename": "Перейменувати канал",
            "group_channel_delete": "Видалити канал",
            "group_channel_rename_prompt": "Нова назва каналу:",
            "group_chat_banned": "Доступ до чату заборонено",
            "group_mic_off": "Мікрофон вимкнено",
            "group_ban_chat": "Заборонити чат",
            "group_allow_chat": "Дозволити чат",
            "group_disable_mic": "Вимкнути мікрофон",
            "group_enable_mic": "Увімкнути мікрофон",
            "group_chat_ban_notice": "Адмін обмежив вам доступ до чату цієї групи.",
            "modal_input_title": "ВВЕДЕННЯ",
            ...
            "profile_delete_confirm_sure": "Ви точно хочете видалити акаунт? Цю дію не можна скасувати — усі дані буде стерто назавжди.",
            ...
            "login_pass_placeholder": "Пароль",
            "login_btn": "Увійти",
            "login_forgot_hint": "Забули пароль?",
            "login_reset_link": "Скинути пароль",
            "login_reset_need_user": "Введіть логін або email, щоб скинути пароль",
            "reset_title": "Скидання пароля",
            "reset_hint": "На вашу пошту надіслано код підтвердження. Введіть його, щоб підтвердити особу.",
            "reset_code_placeholder": "Код з листа",
            "reset_verify_btn": "Підтвердити код",
            "reset_new_password_placeholder": "Новий пароль",
            "reset_confirm_btn": "Змінити пароль",
            "reset_back_login": "← Назад до входу",
            "reset_no_user": "Почніть скидання зі сторінки входу.",
            "reset_enter_code": "Введіть код з листа",
            "reset_code_ok": "Код підтверджено. Введіть новий пароль.",
            "reset_code_bad": "Невірний або застарілий код",
            "reset_enter_password": "Введіть новий пароль",
            "reset_success": "Пароль змінено! Зараз перейдемо до входу…",
            "reset_fail": "Не вдалося змінити пароль",
